...
OBJS = build/crt0.o build/src/main.o $(LIBC_OBJS)
...
build/src/main.o: src/main.c
	gcc -c -Iinclude/libc -fno-stack-protector src/main.c -o build/src/main.o

build/src/libc/%.o: src/libc/%.c
	gcc -c -fno-stack-protector -Iinclude/libc $< -o $@
